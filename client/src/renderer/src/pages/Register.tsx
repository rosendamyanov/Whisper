              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-5 py-4 rounded-xl bg-slate-800/60 backdrop-blur-sm border border-white/[0.08] text-white text-base placeholder-gray-500 focus:outline-none focus:border-cyan-500/50 focus:bg-slate-800/80 transition-all duration-200"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className={`w-full py-4 px-6 mt-4 rounded-xl font-semibold text-white text-sm uppercase tracking-widest transition-all duration-300 transform ${
                    isLoading
