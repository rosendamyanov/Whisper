...
export const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    if (user?.id) {
        fetchChats(user.id); // <--- FIX: Pass real ID, not 'current-user-id'
    }
      ...
      <div className="flex-1 bg-white/[0.02] backdrop-blur-2xl border border-white/[0.05] rounded-[2rem] flex flex-col shadow-2xl overflow-hidden">
        ...
        <div className="p-3 border-t border-white/[0.05] bg-black/20">
          <div className="flex gap-2">
            <button className="flex-1 py-3 rounded-xl bg-[#00b4ff] hover:bg-[#00a0e6] text-white text-xs font-bold transition-all flex items-center justify-center gap-2 shadow-lg shadow-[#00b4ff]/20">
