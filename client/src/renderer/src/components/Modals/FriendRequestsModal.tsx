...
export const FriendRequestsModal = ({ onClose }: { onClose: () => void }) => {
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-2 custom-scrollbar">
          {pendingRequests.length === 0 ? (
            ...
            pendingRequests.map(req => (
              <div key={req.friendshipId} className="flex items-center justify-between p-3 rounded-xl bg-white/[0.03] hover:bg-white/[0.05] transition-colors border border-white/[0.02]">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span className="text-[10px] text-gray-500">
                            {/* {new Date(req.sentAt).toLocaleDateString()} */} Date
                        </span>
                    </div>
                </div>
